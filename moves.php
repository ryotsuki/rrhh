...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="cell-4"><div>
            <select data-role="select" id="cbo_coleccion" data-prepend="Coleccion:">
                <option value="-1" selected="true">TODAS</option>
        ...
        <div class="cell-4"><div>
            <select data-role="select" id="cbo_anio" data-prepend="Año:">
                <option value="-1" selected="true">TODAS</option>
        ...
        <div class="cell-4"><div>
            <select data-role="select" id="cbo_familia" data-prepend="Familia:">
                <option value="-1" selected="true">TODAS</option>
