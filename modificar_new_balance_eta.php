<?php
    ...
    $consulta_pedido = "SELECT DISTINCT id_pedido,empresa,comprador,correo,valor_pedido FROM V_PEDIDO_ETA WHERE empresa = '$empresa' AND estado_pedido = 0";
...
<head>
    ...
    <script>
        ...
        function busca_pedido(pedido){
            ...
            $.post("datos/buscar_new_balance_eta.php?gender="+gender+"&line="+line+"&ref="+ref+"&pedido="+pedido, function(htmlexterno){
