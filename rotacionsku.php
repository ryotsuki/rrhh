<?php
    ...
    $consulta_almacenes="SELECT * FROM ALMACEN WHERE CODALMACEN IN('C1','C2','C3','C4','C5','C6','C7','B1','B2','B3','B4','B5','B6','B7','B8','BA','BB','N1','N2','N3','E1') ORDER BY NOMBREALMACEN";
...
<head> 
    ...
    <script>
        function buscarsku(){
            ...
            $.post("datos/consulta_rotacion_sku.php?fecha="+fecha+"&fecha2="+fecha2+"&referencia="+referencia+"&color="+color+"&almacen="+almacen+"&marca="+marca+"&anio="+anio+"&coleccion="+coleccion+"&ciclo="+ciclo+"&familia="+familia, function(htmlexterno){
        ...
        function excel(){ 
            ...
            window.open('datos/ex2.php?fecha='+fecha+'&fecha2='+fecha2+'&referencia='+referencia+'&color='+color+'&almacen='+almacen+'&marca='+marca+'&anio='+anio+'&coleccion='+coleccion+'&ciclo='+ciclo+'&familia='+familia, '_blank');
        }
    </script>
</head>
    ...
    <div class="row border-bottom bd-lightGray m-3">
        ...
        <div class="cell-md-8 d-flex flex-justify-center flex-justify-end-md flex-align-center">
            <ul class="breadcrumbs bg-transparent">
                ...
                <li class="page-item"><a href="#" class="page-link">Consulta de Rotacion</a></li>
            </ul>
        </div>
    </div>
