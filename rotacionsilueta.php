...
<head> 
    ...
    <script>
        function buscarsku(){
            ...
            $.post("datos/consulta_rotacion_silueta.php?fecha="+fecha+"&fecha2="+fecha2+"&referencia="+referencia+"&almacen="+almacen+"&marca="+marca+"&anio="+anio+"&coleccion="+coleccion+"&ciclo="+ciclo+"&familia="+familia, function(htmlexterno){
        ...
        function excel(){ 
            ...
            window.open('datos/exsilueta.php?fecha='+fecha+'&fecha2='+fecha2+'&referencia='+referencia+'&almacen='+almacen+'&marca='+marca+'&anio='+anio+'&coleccion='+coleccion+'&ciclo='+ciclo+'&familia='+familia, '_blank');
        }
    </script>
</head>
...
<div class="container">
    ...
    <div class="row">
        <div class="cell-4"><div>
            <input type="text" data-role="input" data-prepend="Silueta: " id="txt_referencia">
        </div></div>
        <div class="cell-4"><div>
            <select data-role="select" id="cbo_almacen" data-prepend="Almacen:">
                <option value="-1" selected="true">TODOS</option>
                <option value="3" selected="true">DEPARTAMENTAL</option>
