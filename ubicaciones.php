...
<div class="container">
    ...
    <div class="row border-bottom bd-lightGray m-3">
        ...
        <div class="cell-md-8 d-flex flex-justify-center flex-justify-end-md flex-align-center">
            <ul class="breadcrumbs bg-transparent">
                ...
                <li class="page-item"><a href="#" class="page-link">Consulta de Ubicaciones en Bodega</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="container" id="tabla_datos">
        ...
        >
            <thead>
            <tr>
                <th class="sortable-column sort-asc">ARTICULOS</th>
                <th class="sortable-column sort-asc">CODIGO BARRAS</th>
