...
curl_setopt_array($curl, [
  ...
  //CURLOPT_URL => "https://novomodecol.vtexcommercestable.com.br/api/giftcards//transactions",
  CURLOPT_URL => "https://apigateway-gaianetcore.preprodppm.com/identity-api/oauth/token",
  ...
  CURLOPT_HTTPHEADER => [
    ...
    "X-VTEX-API-AppToken: ac9d7dc7-9ea0-4a78-862c-f1be4d098509"
  ],
]);
