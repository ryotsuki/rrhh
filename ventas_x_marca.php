<?php
    ...
    $consulta_movimientos = "SELECT sum(VTA_NETA) AS VENTA_NETA, sum(CANTIDAD_VTA) AS UNIDADES,MARCA,ALMACEN,VENDEDOR  from ventas where datepart(year,fecha) = 2021 and datepart(month,fecha) = 6 AND VENDEDOR IS NOT NULL AND ALMACEN IS NOT NULL GROUP BY MARCA,ALMACEN,VENDEDOR";
...
<head>
    ...
    <script>
        function buscar(){
            ...
            $.post("datos/consulta_x_marca.php?marca="+marca+"&desde="+desde+"&hasta="+hasta, function(htmlexterno){
...
<div class="container">
    ...
    <div class="row border-bottom bd-lightGray m-3">
        ...
        <div class="cell-md-8 d-flex flex-justify-center flex-justify-end-md flex-align-center">
            <ul class="breadcrumbs bg-transparent">
                <li class="page-item"><a href="#" class="page-link"><span class="mif-chevron-right"></span></a></li>
                <li class="page-item"><a href="#" class="page-link">Ventas por Marca</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="cell-3"><div>
            <select data-role="select" multiple id="cbo_marca">
