...
<script>
    function guardar(){
        ...
        if(fecha == '' || inicio == '' || fin == '' || observaciones == ''){
            ...
            $.post("datos/guarda_vacaciones.php?fecha="+fecha+"&inicio="+inicio+"&fin="+fin+"&observaciones="+observaciones, function(htmlexterno){
...
<div class="row border-bottom bd-lightGray m-3">
    ...
    <div class="cell-md-8 d-flex flex-justify-center flex-justify-end-md flex-align-center">
        <ul class="breadcrumbs bg-transparent">
            <li class="page-item"><a href="#" class="page-link"><span class="mif-airplane"></span></a></li>
            <li class="page-item"><a href="#" class="page-link">Vacaciones</a></li>
        </ul>
    </div>
</div>
...
<div id="tabla_datos">
    ...
    <div class="social-box">
        <div class="header bg-green fg-white">
            ...
            <div class="title">Ingreso de solicitud de vacaciones</div>
        ...
        <ul class="skills">
            ...
            <li>
                <div class="text-bold">
                    <input id="txt_inicio" type="text" data-role="calendarpicker">
                </div>
                <div>Fecha inicio</div>
            </li>
            <li>
                <div class="text-bold">
                    <input id="txt_fin" type="text" data-role="calendarpicker">
                </div>
                <div>Fecha fin</div>
            </li>
            <li>
