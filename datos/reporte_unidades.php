...
if(strpos($username, "NEW") !== false) {
    ...
    $sql_uno="SELECT count(distinct numero_documento),vendedor,almacen from v_ventas_por_vendedor_unidades_new where fecha between '".$an."-".$me."-".$di."T00:00:00' and GETDATE() $filtro_tienda group by vendedor,almacen order by almacen, vendedor";
