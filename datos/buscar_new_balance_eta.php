...
if($ref != "TODOS"){
    ...
    if($pedido == ""){
        $sql="SELECT * FROM DATOS_ARTICULOS_NB_ETA WHERE 1=1 $consulta_gender $consulta_line $consulta_ref";
    }
    else{
        $sql="SELECT * FROM V_PEDIDO_ETA WHERE 1=1 AND id_pedido = $pedido $consulta_gender $consulta_line $consulta_ref";
...
<script>
    ...
    function buscar2(){
        ...
        $.post("datos/buscar_new_balance_eta.php?gender="+gender1+"&line="+line1+"&ref="+ref1+"&pedido="+pedido, function(htmlexterno){
    ...
    function guardar(){
        ...
        $('#tabla_articulos > tbody > tr').each(function(){
            ...
            $.ajax({
                type: "POST",
                dataType:"html",
                url: "datos/guarda_pedido_eta.php",	
    ...
    <table class="table compact striped table-border mt-4" id="tabla_articulos">
        ...
        <tr>
            <td>
                ...
                data-popover-text="
                    <div class='text-center'>
                        <img src='images/fotos/<?php echo $row["style"]?>_2.jpg' style='height: 300px;'>
                    </div>"
                data-popover-position="right"
                     src="images/fotos/<?php echo $row["style"]?>_2.jpg" width="100" heigh="100" id="foto">
            </td>
