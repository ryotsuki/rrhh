...
<head>
    ...
    <script> 
        ...
        function new_balance(){
            //alert("Hola");
            $.post("productos_new_balance_eta.php", function(htmlexterno){
        ...
        function modificar_new_balance(){
            //alert("Hola");
            $.post("modificar_new_balance_eta.php", function(htmlexterno){
                $('#mostrar_contenido').fadeOut('slow');
                $('#mostrar_contenido').fadeIn('slow');
                $("#mostrar_contenido").html(htmlexterno);
            });
        ...
        function listado_pedidos(){
            //alert("Hola");
            $.post("listado_pedidos_eta.php", function(htmlexterno){
                $('#mostrar_contenido').fadeOut('slow');
                $('#mostrar_contenido').fadeIn('slow');
                $("#mostrar_contenido").html(htmlexterno);
            });
...
<aside class="sidebar pos-absolute z-2"
    ...
    <ul class="sidebar-menu">
        <li><a onclick="new_balance();" href="#"><span class="mif-plus icon"></span>Nuevo Pedido NB</a></li>
        <li><a onclick="modificar_new_balance();" href="#"><span class="mif-floppy-disk icon"></span>Modificar Pedido NB</a></li>
        <li><a onclick="listado_pedidos();" href="#"><span class="mif-checkmark icon"></span>Pedidos finalizados</a></li>
        <li><a href="login_pedidos_eta"><span class="mif-exit icon"></span>Cerrar Sesión</a></li>
...
<div class="shifted-content h-100 p-ab">
    ...
    <div class="h-100 p-4" id="mostrar_contenido" name="mostrar_contenido">
        ...
        <p>
           ...
           Para desplegar el menú, click en la esquina superior izquierda en el <span class="mif-menu mif-3x fg-red"></span>.
        </p>
    </div>
</div>
