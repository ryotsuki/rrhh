...
<head>
    ...
    <script>
        function buscar(){
            ...
            if(franquicia == 1){ 
                $.post("datos/consulta_capitalizacion2.php?desde="+desde+"&hasta="+hasta+"&desde3="+desde3+"&hasta3="+hasta3, function(htmlexterno){
            ...
            if(franquicia == 2){ 
                $.post("datos/consulta_capitalizacion_siete2.php?desde="+desde+"&hasta="+hasta+"&desde3="+desde3+"&hasta3="+hasta3, function(htmlexterno){
                    $('#tabla_datos').fadeOut('slow');
                    $('#tabla_datos').fadeIn('slow');
                    $("#tabla_datos").html(htmlexterno);
                });
    ...
    <div class="row border-bottom bd-lightGray m-3">
        ...
        <div class="cell-md-8 d-flex flex-justify-center flex-justify-end-md flex-align-center">
            <ul class="breadcrumbs bg-transparent">
                ...
                <li class="page-item"><a href="#" class="page-link">Capitalizacion por Segmento</a></li>
            </ul>
        </div>
    </div>
